...
class Member(models.Model):
    ...
    name = models.CharField(
        max_length=100)
    phone = models.CharField(max_length=13, unique=True,  error_messages={
                             'unique': 'በዚህ ስልክቁጥር የተመዘገበ ደንበኛ አለ!'})
    address = models.CharField(
        max_length=255)
    is_equbtegna = models.BooleanField(default=False, editable=True)
    chat_id = models.CharField(
        default=None, editable=True, null=True, blank=True, max_length=100)
...
class Review(models.Model):
    ...
    book = models.ForeignKey(
        Book, on_delete=models.CASCADE, related_name="review", null=True)
